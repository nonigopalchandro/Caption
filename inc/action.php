...
//************************************************* blog_posts  **********************************************
	...
	{	
		...
		if($row1hello<1)
		{
			$hellopost = "INSERT INTO `blog_posts` (`id`, `postTitle`, `description`, `post_date`, `auther`, `catinfo`) VALUES (NULL, 'Hello World', 'This is a Sample Post for saying blog setup is successfully completed, you good to go for blogging!', CURRENT_TIMESTAMP, 'You', '1')";
...
//************************************************** blog cats ****************************************************
	...
	{	
		...
		if($rownum<1)
		{
			$q1 = "INSERT INTO blog_cats (catID, catTitle, catSlug) VALUES (NULL, 'Sample Writter', 'sample writter')";
			mysqli_query($con,$q1);
