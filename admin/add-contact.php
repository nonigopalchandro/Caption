...
{
	$contact = trim($_POST['content']);
	
	$sql = "insert into webcontact (id, contact) values ('$id', '".$contact."')";
...
<?php  
$sql = "SELECT id, contact from webcontact";
...
<center><a href="delete-contact.php?id=<?php echo $row["id"]; ?>">Delete</a> | <a href="edit-contact.php?id=<?php echo $row["id"]; ?>">Edit</a></center>
