...
{
	$about = trim($_POST['content']);
	
	$sql = "insert into webabout (id, about) values ('$id', '".$about."')";
...
<?php  
$sql = "SELECT id, about from webabout";
...
<center><a href="delete-about.php?id=<?php echo $row["id"]; ?>">Delete</a> | <a href="edit-about.php?id=<?php echo $row["id"]; ?>">Edit</a></center>
